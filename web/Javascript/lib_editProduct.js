...
function EvaluateSellBuy(input)
{
    if(input=="Selling")
    {
        document.getElementById("selling").checked=true;
        document.getElementById("buying").checked=false; 
        document.getElementById("RightSide").innerHTML="<h2>Upload a photo</h2>"
    ...
    {
        document.getElementById("buying").checked=true;
        document.getElementById("selling").checked=false;
...
function EvaluateProductService(input_type,input_status)
{
    if(input_type=="false") //Product
    {
        ...
        if(input_status=="false")
            ...
            document.getElementById("usedPrd").checked=true;
